...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$2, 16, 8, 327);
    			attr_dev(input0, "name", "temperature");
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "min", "0");
    			attr_dev(input0, "max", "1");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file$2, 16, 72, 391);
    			attr_dev(label1, "for", "length");
    			add_location(label1, file$2, 17, 8, 489);
    			attr_dev(input1, "name", "length");
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "max", "100");
    			add_location(input1, file$2, 17, 57, 538);
    			attr_dev(div, "class", "controls svelte-1vlqyn1");
    			add_location(div, file$2, 15, 4, 279);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*controlsOpen*/ ctx[0] && create_if_block_1(ctx);

    	function select_block_type(ctx, dirty) {
    		if (/*controlsOpen*/ ctx[0]) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			if_block1.c();
    			attr_dev(button, "class", "showhide svelte-1vlqyn1");
    			add_location(button, file$2, 20, 4, 635);
    			attr_dev(div, "class", "wrapper svelte-1vlqyn1");
    			add_location(div, file$2, 13, 0, 230);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*toggleOpen*/ ctx[3], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
