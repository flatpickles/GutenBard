...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div_transition) div_transition = create_bidirectional_transition(div, /*fadeSlide*/ ctx[1], { duration: 200 }, true);
    		...
    		o: function outro(local) {
    			if (!div_transition) div_transition = create_bidirectional_transition(div, /*fadeSlide*/ ctx[1], { duration: 200 }, false);
    ...
    function create_fragment$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*aboutOpen*/ ctx[0] && create_if_block(ctx);
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span, "click", /*toggleOpen*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function toggleOpen() {
    		$$invalidate(0, aboutOpen = !aboutOpen);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('aboutOpen' in $$props) $$invalidate(0, aboutOpen = $$props.aboutOpen);
    		if ('generatorLength' in $$props) generatorLength = $$props.generatorLength;
    		if ('seedLength' in $$props) seedLength = $$props.seedLength;
    	};
    	...
    	return [aboutOpen, fadeSlide, toggleOpen];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-1u64lc1");
    			add_location(div, file$1, 112, 0, 4147);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function displayText(primaryText, secondaryText, caretPosition) {
    		...
    		? "<span id='primaryText'>" + primaryText + "</span>"
    		: "";
    	...
    	function onKeyDown(event) {
    		...
    		if (event.keyCode == "37" || event.keyCode == "38" || event.keyCode == "39" || event.keyCode == "40") {
    			...
    			delayed(() => {
    				updateEditor(true, false);
    			});
    		} else {
    			// Text input (or I've forgotten something)
    			// Clear, then update
    			clearSecondaryText();
    	...
    	return [editorDiv, onKeyDown, onClick, div_binding];
    }
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ About, Editor });
    	return [];
    }
