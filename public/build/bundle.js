...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("Temperature: ");
    			t1 = text(/*temperatureInput*/ ctx[1]);
    			input0 = element("input");
    			t2 = space();
    			label1 = element("label");
    			t3 = text("Length: ");
    			t4 = text(/*lengthInput*/ ctx[2]);
    			input1 = element("input");
    			attr_dev(label0, "for", "temperature");
    			add_location(label0, file$2, 27, 8, 548);
    			attr_dev(input0, "name", "temperature");
    			attr_dev(input0, "type", "range");
    			attr_dev(input0, "min", "0");
    			attr_dev(input0, "max", "1");
    			attr_dev(input0, "step", "0.01");
    			add_location(input0, file$2, 27, 72, 612);
    			attr_dev(label1, "for", "length");
    			add_location(label1, file$2, 28, 8, 710);
    			attr_dev(input1, "name", "length");
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "1");
    			attr_dev(input1, "max", "100");
    			add_location(input1, file$2, 28, 57, 759);
    			attr_dev(div, "class", "controls svelte-mzwa6k");
    			add_location(div, file$2, 26, 4, 476);
    		},
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*temperatureInput*/ ctx[1]);
    			append_dev(div, t2);
    			append_dev(div, label1);
    			append_dev(label1, t3);
    			append_dev(label1, t4);
    			append_dev(div, input1);
    			set_input_value(input1, /*lengthInput*/ ctx[2]);
    			current = true;
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty & /*temperatureInput*/ 2) set_data_dev(t1, /*temperatureInput*/ ctx[1]);

    			if (dirty & /*temperatureInput*/ 2) {
    				set_input_value(input0, /*temperatureInput*/ ctx[1]);
    			}

    			if (!current || dirty & /*lengthInput*/ 4) set_data_dev(t4, /*lengthInput*/ ctx[2]);

    			if (dirty & /*lengthInput*/ 4) {
    				set_input_value(input1, /*lengthInput*/ ctx[2]);
    			}
    		},
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div_transition) div_transition = create_bidirectional_transition(div, /*fadeSlide*/ ctx[3], { duration: 200 }, true);
    		...
    		o: function outro(local) {
    			if (!div_transition) div_transition = create_bidirectional_transition(div, /*fadeSlide*/ ctx[3], { duration: 200 }, false);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span, "class", "svelte-mzwa6k");
    			toggle_class(span, "selected", /*controlsOpen*/ ctx[0]);
    			add_location(span, file$2, 31, 4, 856);
    			attr_dev(div, "class", "wrapper svelte-mzwa6k");
    			add_location(div, file$2, 24, 0, 427);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function input0_change_input_handler() {
    		temperatureInput = to_number(this.value);
    		$$invalidate(1, temperatureInput);
    	}

    	function input1_change_input_handler() {
    		lengthInput = to_number(this.value);
    		$$invalidate(2, lengthInput);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('temperatureInput' in $$props) $$invalidate(1, temperatureInput = $$props.temperatureInput);
    		if ('lengthInput' in $$props) $$invalidate(2, lengthInput = $$props.lengthInput);
    	};
